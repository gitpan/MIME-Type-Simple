...
can_ok("MIME::Type::Simple",
  qw( is_type alt_types ext_from_type ext3_from_type is_ext type_from_ext add_type split_type ));
...
{
	my $o = MIME::Type::Simple->new();

	ok($o->isa("MIME::Type::Simple"), "isa");
